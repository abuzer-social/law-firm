...
@section('content')
    <div class="contact-container">
        <div class="container">
            <div class="text-center max-50 m-auto" @if(app()->getLocale() == 'ar') dir="rtl" @endif>
                <h2 class="fw-bold pb-2 primary">
            ...
            <div class="container">
                <div class="card benefit-card">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="px-5 py-3" @if(app()->getLocale() == 'ar') dir="rtl" style="text-align: right;" @endif>
                                <form action="">
                                    <div class="mb-3">
                                        <label for="" class="form-label fw-semibold">{{ __('contact.contact_card.form.labels.name') }}</label>
                                        <input type="text" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label for="" class="form-label fw-semibold">{{ __('contact.contact_card.form.labels.email') }}</label>
                                        <div class="input-group">
                                            <input type="email" class="form-control">
                                        </div>
                                    </div>
                                    <div class="mb-3">
                                        <label for="" class="form-label fw-semibold">{{ __('contact.contact_card.form.labels.phone') }}</label>
                                        <input type="number" id="phone" class="form-control" name="name">
                                    </div>
                                    <div class="mb-3">
                                        <label for="" class="form-label fw-semibold">{{ __('contact.contact_card.form.labels.subject') }}</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                        <label for="" class="form-label fw-semibold">{{ __('contact.contact_card.form.labels.message') }}</label>
