...
return [
    ...
    'sections' => [
        ...
        'definitions' => [
            ...
            'items' => [
                [
                    'term' => '"Platform", "Defaa", "we" or "us"',
                    'definition' => 'refers to the Defaa electronic platform and application in Saudi Arabia and all related services, as well as the entity owning the website and application.'
                ],
                [
                    'term' => '"Service Provider"',
                    'definition' => 'refers to the individual offering their legal services in their field of expertise, as per their information registered on the platform.'
                ],
                [
                    'term' => '"User", "account", "you"',
                    'definition' => 'refers to the person using or visiting Defaa, registering an account, or requesting services via the platform.'
                ],
                [
                    'term' => '"Client"',
                    'definition' => 'refers to any person or entity using Defaa to obtain various legal consultations and services offered by the platform.'
                ],
                [
                    'term' => '"Legal Service"',
                    'definition' => 'refers to any legal service the client seeks from service providers, including consultations in all legal fields.'
                ],
                [
                    'term' => '"Content"',
                    'definition' => 'refers to any reviews, comments, messages, data, information, text, audio, images, or other materials on the Defaa platform.'
                ],
                [
                    'term' => '"Interactive Areas"',
                    'definition' => 'mean discussion forums, bulletin boards, review services, chats, or other forums provided by Defaa.'
                ],
                [
                    'term' => '"Agreement"',
                    'definition' => 'refers to this document containing various terms, conditions, and policies.'
                ],
                [
                    'term' => '"Privacy Policy Terms"',
                    'definition' => 'refer to data collection methods and ways of protecting user personal information.'
                ],
                [
                    'term' => '"Systems"',
                    'definition' => 'refer to the applicable regulations in Saudi Arabia.'
                ]
            ]
        ],

        'terms_of_use' => [
            'title' => 'Third: Terms Of Use (Client Terms and Conditions, Data, and Attachments)',
            'subsections' => [
        ...
        'privacy_policy' => [
            'title' => 'Fourth: Privacy Policy (Confidentiality and Information Retention)',
            'items' => [
        ...
        'contract_signature' => [
            'title' => 'Fifth: Contract And Electronic Signature',
            'items' => [
        ...
        'subscriptions_payment' => [
            'title' => 'Sixth: Subscriptions And Payment Methods',
            'subsections' => [
        ...
        'termination' => [
            'title' => 'Seventh: Termination of Use',
            'items' => [
        ...
        'intellectual_property_trademark' => [
            'title' => 'Eighth: Intellectual Property Rights and Trademark',
            'subsections' => [
                ...
                'amendments_general' => [
                    'title' => 'Amendments and General Terms',
                    'items' => [
        ...
        'platform_responsibility' => [
            'title' => 'Ninth: Platform Responsibility',
            'items' => [
        ...
        'electronic_contract_signature' => [
            'title' => 'Eleventh: Electronic Contract And Signature',
            'subsections' => [
                'electronic_contract' => [
        ...
        'termination_of_use' => [
            'title' => 'Thirteenth: Termination Of Use',
            'items' => [
        ...
        'general_provisions' => [
            'title' => 'Fourteenth: General Provisions',
            'subsections' => [
                'amendments' => [
        ...
        'communication_legal_notifications' => [
            'title' => 'Fifteenth: The Field Of Communication And Legal Notifications',
            'subsections' => [
                'communication_areas' => [
                    'title' => 'Communication areas',
                    'items' => [
        ...
        'applicable_law' => [
            'title' => 'Sixteenth: Applicable Law',
            'subsections' => [
